...
return array(
	...
	'links'    => array(
		...
		'support_forum'      => array(
			'url'    => 'https://wordpress.org/support/plugin/wynko-for-laposta/',
			'target' => '_blank',
		),
		'github_issues'      => array(
			'url'    => 'https://github.com/FlexBorder/wynko/issues',
			'target' => '_blank',
		),
		'integration_dev_kb' => array(
			'url'    => 'https://getwynko.com/docs/build-an-integration',
			'target' => '_blank',
		),
	),
);
